...
export default function PrivacyPolicyPage() {
  document.title = `${SEO.default.title} | Privacy Policy`;
  ...
  return (
    <div className="container text-left" id="policy-container" style={{ color: '#6d6d6d' }}>
      <div className="row p-2">
        <h3 style={{ fontSize: '1.5em !important' }}>Privacy Policy</h3>
        <div>
        ...
        <div className="policy-content">
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Good Human, Gurgaon.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to Good Human, accessible from <a href="https://the.goodhuman.in/" rel="external nofollow noopener" target="_blank">https://the.goodhuman.in/</a></p>
            </li>
            <li>
        ...
        <div className="policy-content">
          ...
          <ul>
            <li>By email: <a href="mailto:thegoodhuman.in@gmail.com">thegoodhuman.in@gmail.com</a></li>
          </ul>
        </div>
      </div>
    </div>
